        ...
        {Array.from({ length: max }, (_, index) => {
          ...
          return (
            <button
              ...
              className="rounded p-1 text-zinc-300 transition-colors hover:text-amber-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400"
            >
              <svg
                aria-hidden="true"
                viewBox="0 0 24 24"
                className={cn("h-7 w-7", active ? "text-amber-400" : "text-zinc-300")}
                fill="currentColor"
              >
